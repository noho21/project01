    <table id="productList" class="text-base table-auto border-4 w-full max-w-4xl mx-auto">
                ...
                <td>
                    <div class="button-group flex flex-wrap justify-center space-x-2 h-10">
                        ...
                        <form id="deleteForm" action="{{ route('product.delete', ['id' => $product->id]) }}" method="POST" data-id="{{ $product->id }}">
                            ...
                            <button class="deleteButton py-2 px-3 bg-red-500 rounded-md text-white block md:inline-block" type="button">
                                削除
                            </button>
                        </form>
                    </div>
