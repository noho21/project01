<html>
    <body>
        ...
        @section('content')
            ...
            <table class="m-auto mt-5 w-50" class="products_table">
                <thead class="container text-center m-0 border-top border-end border-start border-dark">
                    <tr class="border-bottom border-dark row  justify-content-md-center">
                        <div class="d-flex justify-content-start align-items-center mt-2 mb-2">
                            ...
                            <th><a class="col col-lg-2 btn btn-primary" href="{{ route('product.new') }}">新規登録</a></th>
                        </div>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($products as $product)
                        <tr class="row justify-content-md-center border-bottom border-dark">
                            <div class="d-flex justify-content-start align-items-center">
                                ...
                                <td class="col col-lg-1 mb-2 mt-2">{{ $product -> product_name }}</td>
                                <td class="col col-lg-1 mb-2 mt-2">{{ $product -> price }}</td>
                                ...
                                <td class="col col-lg-2 d-grid gap-2 d-md-block">
